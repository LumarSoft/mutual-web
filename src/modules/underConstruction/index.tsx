      ...
      <div className="min-h-screen flex flex-col justify-center items-center">
        ...
        <div className="text-center mb-8 max-w-5xl mx-auto">
          <p className="text-gray-500 text-lg md:text-xl lg:text-2xl">
            ...
            <b>
              Centro suboficiales retirados y pensionados - Gendarmeria Nacional
            </b>{" "}
            queremos informarles que estamos trabajando para mejorar la
            experiencia del usuario. ¡Manténganse al tanto!
          </p>
        </div>
      </div>
    </section>
